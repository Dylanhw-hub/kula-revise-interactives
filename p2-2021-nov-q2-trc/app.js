...
const QS = [
  ...
  {id: 'q10', src: '2C', num: '2.3.1', m: 2, t: 'Name any TWO killers in the source that were implicated (accused) in the murder of Griffiths Mxenge. (2 x 1)', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['Joe Mamasela', 'Almond Nofomela', 'David Tshikalanga', 'Paul van Dyk', 'Brigadier Skoon'], c: [0, 1], fb: 'Coetzee testifies that \'the only people &hellip; that did the stabbing of Mr Mxenge were Joe Mamasela, Almond Nofomela and David Tshikalanga\' &ndash; any two of these three. Paul van Dyk moved the car and Brigadier Skoon allegedly gave orders, but neither is named as doing the stabbing. (David Tshikalanga is also a correct answer.)'},
  ...
  {id: 'q14', src: '2D', num: '2.5.1', m: 2, t: 'Identify any TWO perpetrators in the source who were granted amnesty by the TRC for the murder of Griffiths Mxenge. (2 x 1)', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['Dirk Coetzee', 'David Tshikilanga', 'Almond Nofomela', 'Fumbatha Mxenge', 'Brigadier Skoon'], c: [0, 1], fb: 'Source 2D reports amnesty for \'Dirk Coetzee and two accomplices &hellip; David Tshikilanga and Almond Nofomela\' &ndash; any two of these three. Fumbatha Mxenge is Griffiths\'s brother, and Brigadier Skoon is not named among those granted amnesty. (Almond Nofomela is also correct.)'},
  {id: 'q15', src: '2D', num: '2.5.2', m: 2, t: 'Quote TWO reasons from the source why the TRC granted amnesty to the murderers of Griffiths Mxenge. (2 x 1)', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['Coetzee had acted on the \'advice, command or order of one or more senior members of the security branch\'', '\'they regarded it as their duty as policemen who were engaged in the struggle against the ANC\'', '\'none of the applicants knew the deceased, Mxenge, or had any reason to wish to bring about his death\'', 'The Mxenge family agreed to forgive the killers and asked the TRC to release them'], c: [0, 1], fb: 'The committee\'s stated reasons include that Coetzee acted on the orders of senior police, and that the men saw it as their duty in the struggle against the ANC. The \'none of the applicants knew the deceased\' line is also from the source but is about their lack of personal motive; the family forgiveness option is invented &ndash; the family in fact fought the amnesty.'},
