...
const QS = [
  ...
  {id: 'q9', src: '2B', num: '2.2.4', m: 2, t: 'Quote TWO pieces of evidence from the source that suggest why South Africa had \'to sit down around the negotiating table\'. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['The overwhelming victory put an end to outside military aggression', 'The enemy had to swallow its arrogant bullying and negotiate', 'South Africa had completely run out of soldiers to send', 'The United States ordered South Africa to make peace', 'Cuba surrendered to the South African forces'], c: [0, 1], fb: 'The source says the victory \'put an end to outside military aggression\' and \'the enemy had to swallow its usual arrogant bullying and sit down around the negotiating table\'. The others are not stated.'},
