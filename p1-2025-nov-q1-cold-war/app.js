...
const QS = [
  ...
  {id: 'q12', src: '1C', num: '1.4.3', m: 2, t: 'Quote TWO pieces of evidence from the source that suggest the aims of the third goal of the policy of containment.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['The desire to rebuild the European economy', 'The need to contain the Soviet Union', 'The removal of all American troops from Europe', 'The creation of a single European army under American command', 'The immediate independence of all European overseas colonies'], c: [0, 1], fb: 'The third goal, \'the drive for European integration\', brought together \'the need to contain the Soviet Union\' and \'the desire to rebuild the European economy\'. The other options do not appear in the source.'},
