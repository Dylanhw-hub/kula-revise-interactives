...
const SRC = {
  ...
  'compare': {
    label: 'Sources 1A + 1B',
    type: 'Comparison',
    html: `<div class="sp-body"><strong>Source 1A (Churchill's speech)</strong> warns that Soviet control had descended across the capitals of Central and Eastern Europe, describing an 'Iron Curtain' and a growing, unknowable communist threat spreading from Moscow.<br><br><strong>Source 1B (the cartoon)</strong> pictures that same danger as a dark mass of 'communist infiltration and dictatorship threats' looming over small non-communist nations, which Uncle Sam works to fence off using a 'U.S. AID' hammer.</div>`,
    attr: 'Compare the written warning in 1A with the visual warning in 1B.'
  },
  'para': {
