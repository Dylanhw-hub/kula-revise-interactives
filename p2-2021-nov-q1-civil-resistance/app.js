...
const QS = [
  ...
  {id: 'q4', src: '1A', num: '1.1.4', m: 4, t: 'Using the information in the source and your own knowledge, explain why you think the black majority was excluded from the new legislation. (2 x 2)', lv: 2, ll: 'Analysis', opts: ['Including the black majority would have let them outvote the white minority and dismantle apartheid, so exclusion protected white political control', 'The tricameral parliament already reserved a fixed quota of seats for black representatives, so their separate inclusion was unnecessary.', 'The black majority was excluded because they had already been granted full political rights inside the independent Bantustan homelands', 'The tricameral system excluded the black majority only briefly, adding a fourth chamber once the homelands were fully developed'], c: 0, fb: 'As the majority, black South Africans would have outvoted whites and ended apartheid, so they were kept out to protect white power. The claim that the tricameral parliament reserved seats for black representatives is false &ndash; they were shut out of it entirely; likewise the \'full rights in the homelands\' and \'fourth chamber\' options are misconceptions the source does not support.'},
