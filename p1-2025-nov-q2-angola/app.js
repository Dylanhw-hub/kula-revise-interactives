...
const SRC = {
  ...
  'compare': {
    label: 'Sources 2A + 2D',
    type: 'Comparison',
    html: `<div class="sp-body"><strong>Source 2A</strong><br><br>The United States of America (USA) did not want the Popular Movement for the Liberation of Angola (MPLA) to gain control of Angola, and under the direction of the Secretary of State, Henry Kissinger, Central Intelligence Agency (CIA) operations in Angola gained serious ground in 1975. &hellip; With this flexibility, the CIA provided over 22 million dollars in covert support to the National Liberation Front of Angola (FNLA) and the National Union for the Total Liberation of Angola (UNITA) by the fall of 1975.<br><br>&hellip; Kissinger wanted to redeem American foreign policy from [the Vietnam] failure and saw Angola as the place to do it; he wanted to prove that the United States was still the global world power.</div><img class="sp-img" src="2D.png" alt="A cartoon of three figures. In the centre a tall man in glasses wears a suit covered in stars (labelled Kissinger). He stands between two smaller figures with raised fists, one on the left (labelled MPLA) and one on the right (labelled UNITA). Behind his back the central figure reaches towards an open crate filled with weapons, including bombs, grenades and a knife."><div class="sp-body" style="margin-top:12px;"><strong>Source 2D &mdash; cartoon.</strong> Kissinger's speech bubble: '&hellip; and my country as a party involved in the mediation of the conflict, promises to do everything to bring it to a definitive end.'</div>`,
