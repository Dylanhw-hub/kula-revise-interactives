...
const QS = [
  ...
  {id: 'q12', src: '3D', num: '3.5.1', m: 2, t: 'Give TWO reasons in the source which suggest that President Kennedy supported the March on Washington. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['He was impressed by the deep fervour and quiet dignity of the marchers', 'They deserve our appreciation for the detailed preparations and the orderly manner in which the March was conducted.', 'He personally led the March to the Lincoln Memorial', 'He gave the marchers money to help fund the protest', 'He ordered the police to arrest all of the marchers'], c: [0, 1], fb: 'Kennedy was \'impressed with the deep fervour and the quiet dignity\' and said the marchers \'deserve our appreciation for the detailed preparations ... and for the orderly manner\' in which the March was conducted. The other options are not in the source.'},
