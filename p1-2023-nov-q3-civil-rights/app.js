...
const SRC = {
  '3A': {
    ...
    html: `<div class="sp-body">In 1961, the Freedom Riders set out to change the world. They did so by simply boarding a bus, not as Blacks or Whites restricted by an outmoded system of racial discrimination, but as free and full citizens of a democratic nation.<br><br>The Freedom Riders knew that federal law and the Constitution of the United States of America protected their right to travel together, even in the Deep South where the local law and custom mandated (authorised) racial separation. They also knew that they might be injured or even killed for trying to exercise that right. When riots ensued, the potential violence became too real, and a nation recoiled (reacted) in horror. Unfazed (not discouraged), the Freedom Riders kept coming, more than four hundred in all, filling the freedom buses and marching into jails of the Jim Crow South.<br><br>The resolute (determined) courage and commitment of the Freedom Riders had brought non-violent direct action to the centre stage of American public life. This interracial, non-violent army forced John F Kennedy's administration to confront the immediacy of a civil rights struggle that had captured the world's attention. By the end of 1961 a sweeping desegregation order was in effect and the federal government was moving towards active involvement in the struggle for racial justice.</div>`,
    attr: 'From Freedom Riders: 1961 and the Struggle for Racial Justice by R Arsenault'
  },
  '3B': {
    label: 'Source 3B',
    type: 'Newspaper Article',
    html: `<img class="sp-img" src="3B.png" alt="A black-and-white newspaper photograph of a Greyhound bus on fire, billowing thick smoke at the roadside, with Freedom Riders and onlookers standing and sitting beside it. A label above the photograph reads 'The Flames of Hatred!'"><div class="sp-body" style="margin-top:12px;">The article was headlined 'Inhuman!'. The smoke and flames from the burning bus are labelled 'The Flames of Hatred!'.</div>`,
    attr: 'From the New York Amsterdam News, 20 May 1961'
  },
  '3C': {
    label: 'Source 3C',
    type: 'Interview Extract',
    html: `<div class="sp-body"><strong>Q:</strong> You got involved in the Freedom Rides &hellip;<br><br><strong>Zwerg:</strong> Well, we got word on the Congress for Racial Equality (CORE) Freedom Ride &hellip; We got word of the burning of the bus in Anniston &hellip; we had a meeting long into the night as soon as we heard about it. The feeling was that if we let those perpetrators of violence believe that people would stop if they were violent enough, then we would take serious steps backwards. Right away the feeling was that we needed to ride.<br><br>I was one of 18 that volunteered to go. I've been asked why I volunteered &hellip; It was the right thing for me to do. I never second-guessed it.<br><br>&hellip; It was an uneventful ride until we got to the Birmingham city limits. We were pulled over by the police &hellip; They came on the bus and said, 'This is a Freedom Rider bus! Who is from Nashville?' &hellip; We were both placed under arrest, taken off the bus. One of the things we agreed on is that if you were jailed, you go on a hunger strike, because in our minds we were jailed illegally. You don't cop (opt for) a plea; you don't pay the bail and jump. You stay.</div>`,
    attr: 'Jim Zwerg, a Freedom Rider, interviewed by S Nelson (PBS Home Video, Freedom Riders), viewed 12 February 2023'
  },
  '3D': {
    label: 'Source 3D',
    type: 'Interview Extract',
    html: `<div class="sp-body">The bus started exploding, and a lot of people were cut by flying glass. We were taken to the hospital, most of us, for smoke inhalation &hellip; I think I was half out of it, half dazed (confused), as a result of the smoke. You got to the point where you started having the dry heaves (shivers).<br><br>The people at the hospital would not do anything for us. They would not. And I was saying, 'You are doctors, you are medical personnel'. They wouldn't. Governor Patterson got on state-wide radio and said, 'Any rioters in this state will not receive police protection'. And then the crowd started forming outside the hospital, and the hospital told us to leave. A caravan from Birmingham, led by the Reverend Fred Shuttlesworth, came up to get us out &hellip;<br><br>For that, they could in part thank Governor John Patterson. A militant segregationist who solicited (asked) Ku Klux Klan support in his election campaign, Patterson once said that integration would come to Alabama only 'over my dead body'. In his inaugural address Patterson declared, 'I will oppose with every ounce of energy I possess &hellip; any mixing of white and Negro races in the classrooms of this state.'</div>`,
    attr: 'H Thomas, a Freedom Rider, interviewed by H Raines, from My Soul is Rested: Movement Days in the Deep South Remembered'
  },
  'compare': {
    label: 'Sources 3C + 3D',
    type: 'Comparison',
    html: `<div class="sp-body"><strong>Source 3C (Zwerg)</strong><br><br>&hellip; We were pulled over by the police &hellip; 'This is a Freedom Rider bus!' &hellip; We were both placed under arrest, taken off the bus &hellip; if you were jailed, you go on a hunger strike &hellip; You stay.</div><div class="sp-body" style="margin-top:12px;"><strong>Source 3D (Thomas)</strong><br><br>The bus started exploding &hellip; We were taken to the hospital &hellip; The people at the hospital would not do anything for us &hellip; 'Any rioters in this state will not receive police protection' &hellip; the hospital told us to leave.</div>`,
    attr: 'Re-read both sources, then explain how they connect.'
  },
  'para': {
    label: 'Paragraph Task',
    type: 'Q3.6, 8 marks',
    html: `<div class="sp-body">Now build an eight-mark paragraph answering the guiding question: <em>What challenges were encountered by the civil rights protestors who participated in the Freedom Rides in the USA in the 1960s?</em><br><br>Work through it in four steps &ndash; a topic sentence, evidence from the sources, your own knowledge, and a synthesising conclusion. Choose the strongest option at each step.</div>`,
...
const QS = [
  {id: 'q1', src: '3A', num: '3.1.1', m: 2, t: 'How, according to the source, did the Freedom Riders set out to challenge racial discrimination in the USA in 1961?', lv: 1, ll: 'Extraction', opts: ['By simply boarding a bus together, not as restricted Blacks or Whites, but as free and full citizens of a democratic nation.', 'By refusing to travel on any of the buses in the American South.', 'By taking up arms and fighting the segregationist authorities.', 'By leaving the United States altogether in protest against racial laws.'], c: 0, fb: 'The source says they challenged discrimination \'by simply boarding a bus ... as free and full citizens of a democratic nation\'. The other options are not in the source.'},
  {id: 'q2', src: '3A', num: '3.1.2', m: 2, t: 'Define the term constitution in your own words.', lv: 1, ll: 'Concept', opts: ['The set of basic laws and principles by which a country is governed, setting out people\'s rights.', 'A temporary agreement between two countries to bring an end to a war.', 'A local custom that separates people according to their race.', 'A single law that bans all travel between different states.'], c: 0, fb: 'A constitution is the basic law of a country that sets out how it is governed and protects rights. The other options describe a treaty, a custom or a single law.'},
  {id: 'q3', src: '3A', num: '3.1.3', m: 2, t: 'Comment on what is meant by the statement, \'They also knew that they might be injured or even killed for trying to exercise that right [of travelling together]\'.', lv: 2, ll: 'Interpretation', opts: ['It means the Freedom Riders knew they faced serious violence, even death, yet chose to continue in defence of their rights.', 'It means the Freedom Riders were certain that they would come to no harm at all.', 'It means that only the bus drivers were ever in any real danger.', 'It means the riders gave up as soon as the violence began.'], c: 0, fb: 'The riders knew the deadly risks but rode anyway, showing great courage. The other options deny the danger or their determination.'},
  {id: 'q4', src: '3A', num: '3.1.4', m: 4, t: 'Using the information in the source and your own knowledge, explain why President John F Kennedy took immediate action in desegregating the USA.', lv: 2, ll: 'Interpretation', opts: ['The Freedom Rides exposed unconstitutional violence, captured world attention and forced Kennedy\'s government to act to protect civil rights.', 'Kennedy acted because the Freedom Riders had asked him to leave things exactly as they were.', 'Kennedy acted because the segregationists demanded even stronger racial laws.', 'Kennedy acted because no one in America was paying any attention to the issue.'], c: 0, fb: 'The world\'s attention and the unconstitutional violence forced Kennedy to act. The other options reverse the pressure on him.'},
  {id: 'q5', src: '3B', num: '3.2.1', m: 2, t: 'Explain why you think this newspaper article made front-page headline news.', lv: 2, ll: 'Interpretation', opts: ['The shocking violence against peaceful Freedom Riders, like the burning bus, was dramatic and exposed the brutality of segregation.', 'Because the Freedom Riders had won a great and completely peaceful victory.', 'Because nothing else important had happened anywhere else on that day.', 'Because the newspaper strongly supported racial segregation in the South.'], c: 0, fb: 'The dramatic violence, a firebombed bus, exposed the brutality of segregation and made powerful front-page news. The other options misjudge the story.'},
  {id: 'q6', src: '3B', num: '3.2.2', m: 4, t: 'Why do you think this article was titled, \'Inhuman!\'?', lv: 2, ll: 'Interpretation', opts: ['To condemn the cruel, brutal treatment of the Freedom Riders as inhumane and to show outrage at the violence they suffered.', 'To praise the actions of the mob that attacked the Freedom Riders on the bus.', 'To suggest that the Freedom Riders themselves had behaved inhumanely.', 'To report that no one at all had been harmed during the Freedom Rides.'], c: 0, fb: 'The title \'Inhuman!\' condemns the brutal treatment of the riders as inhumane. The other options reverse the blame or deny the harm.'},
  {id: 'q7', src: '3B', num: '3.2.3', m: 2, t: 'Comment on why the flames and smoke from the burning bus are labelled, \'The Flames of Hatred!\'.', lv: 2, ll: 'Interpretation', opts: ['The burning bus symbolised the racial hatred and violence directed at the Freedom Riders by the segregationists.', 'The flames stood for the warmth and welcome the riders received in Alabama.', 'The flames showed the riders\' own anger at being arrested by the police.', 'The flames represented a public celebration of the end of segregation.'], c: 0, fb: 'The flames stand for the racial hatred that drove the violence against the riders. The other options reverse or misread the symbol.'},
  {id: 'q8', src: '3C', num: '3.3.1', m: 1, t: 'What, according to the source, motivated Zwerg and his colleagues to get involved in the Freedom Rides?', lv: 1, ll: 'Extraction', opts: ['That if violence made people stop, the movement would take serious steps backwards, so they needed to keep riding.', 'That the Freedom Rides were an easy and completely safe thing to do.', 'That the government had paid them to take part in the rides.', 'That they wanted to give up the campaign for civil rights.'], c: 0, fb: 'Zwerg says stopping would mean \'serious steps backwards\', so they needed to ride. The other options are not in the source.'},
  {id: 'q9', src: '3C', num: '3.3.2', m: 2, t: 'Give TWO options, stated by Zwerg, that activists would take if they were jailed for participating in the Freedom Rides. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['Go on a hunger strike', 'Stay in jail rather than pay bail and jump', 'Pay the bail and leave at once', 'Sign a full confession of guilt', 'Escape from the jail in secret'], c: [0, 1], fb: 'Zwerg says \'if you were jailed, you go on a hunger strike\' and \'you don\'t pay the bail and jump. You stay\'. The other options contradict this.'},
  {id: 'q10', src: '3C', num: '3.3.3', m: 4, t: 'Why would a historian consider this source reliable when researching the 1961 Freedom Rides in the USA?', lv: 3, ll: 'Reliability', opts: ['Reliable because it is a first-hand interview with Jim Zwerg, an actual Freedom Rider who took part in the 1961 rides.', 'Reliable because it was written by someone with no link at all to the Freedom Rides.', 'Reliable because it gives detailed statistics on every single bus in the rides.', 'Reliable because it was written long before the Freedom Rides had taken place.'], c: 0, fb: 'As a first-hand account by a real Freedom Rider, the source is reliable eyewitness evidence. The other options describe features that would weaken reliability.'},
  {id: 'q11', src: '3D', num: '3.4.1', m: 3, t: 'Give THREE reasons in the source why the protestors were taken to the hospital after the bus explosion. Choose THREE responses.', lv: 1, ll: 'Extraction', multi: true, mx: 3, opts: ['Smoke inhalation from the burning bus', 'Cuts from the flying glass', 'Dry heaves and dizziness from the smoke', 'Gunshot wounds from the police', 'Injuries from a separate car accident', 'Illness from eating contaminated food'], c: [0, 1, 2], fb: 'The source describes smoke inhalation, cuts from flying glass, and being dazed with the \'dry heaves\' from the smoke. The other options are not in the source.'},
  {id: 'q12', src: '3D', num: '3.4.2', m: 4, t: 'Comment on what is implied by Governor Patterson\'s statement regarding the Freedom Riders, \'Any rioters in this state will not receive police protection\'.', lv: 2, ll: 'Interpretation', opts: ['It implies the state authorities sided with the segregationists and would leave the Freedom Riders unprotected against mob violence.', 'It implies that Governor Patterson strongly supported the aims of the Freedom Riders.', 'It implies that the police would protect absolutely everyone equally in Alabama.', 'It implies that there was no violence at all directed against the Freedom Riders.'], c: 0, fb: 'By calling the riders \'rioters\' and denying them protection, Patterson sided with the segregationists and exposed the riders to mob violence. The other options reverse this.'},
  {id: 'q13', src: '3D', num: '3.4.3', m: 2, t: 'Quote evidence from the source which indicates that the hospital did not administer or accept the injured Freedom Riders. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['\'The people at the hospital would not do anything for us\'', '\'The hospital told us to leave\'', '\'The doctors treated all of our injuries at once\'', '\'We were given beds and cared for overnight\'', '\'The hospital protected us from the crowd outside\''], c: [0, 1], fb: 'The source says \'the people at the hospital would not do anything for us\' and \'the hospital told us to leave\'. The other options are the opposite of what happened.'},
  {id: 'q14', src: '3D', num: '3.4.4', m: 2, t: 'Explain the term segregationist in the context of the state of Alabama.', lv: 2, ll: 'Concept', opts: ['Someone who supports the forced separation of people by race and opposes any mixing of the races.', 'Someone who fights for the equal and fair treatment of all races.', 'A person who refuses to take any side at all on the issue of race.', 'A leader who governs a country without ever holding elections.'], c: 0, fb: 'A segregationist backs the forced separation of the races, as Patterson did in Alabama. The other options describe equality, neutrality or autocracy.'},
  {id: 'q15', src: '3D', num: '3.4.5', m: 2, t: 'Give TWO pieces of evidence from the source indicating that Governor Patterson was a \'militant segregationist\'. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['He solicited Ku Klux Klan support in his election campaign', 'He said integration would come to Alabama only \'over my dead body\'', 'He personally led the Freedom Rides to New Orleans', 'He gave the injured riders medical care himself', 'He passed laws to end segregation in Alabama'], c: [0, 1], fb: 'The source says Patterson \'solicited Ku Klux Klan support\' and said integration would come only \'over my dead body\'. The other options are the opposite of his views.'},
  {id: 'q16', src: 'compare', num: '3.5', m: 4, t: 'Consult Sources 3C and 3D. Explain how the evidence in Source 3C is supported by the information in Source 3D regarding the treatment of the Freedom Riders.', lv: 3, ll: 'Comparison', opts: ['Both show the riders were met with violence and hostility: 3C describes arrest and the bus burning, and 3D describes injuries and being denied hospital care.', 'They contradict each other: 3C says the riders were welcomed while 3D says they were attacked.', 'Both show that the Freedom Riders were treated kindly and fully protected by the state.', '3C supports 3D by proving that no Freedom Riders were ever harmed in any way.'], c: 0, fb: 'Both show the riders facing violence and hostility, arrest in 3C and injury and refused care in 3D. They agree; they do not contradict or show kind treatment.'},
  {id: 'q17', src: 'para', num: '3.6a', m: 2, t: 'Choose the best topic sentence for a paragraph explaining the challenges encountered by the civil rights protestors who participated in the Freedom Rides.', lv: 3, ll: 'Synthesis', opts: ['The Freedom Riders faced brutal challenges in the 1960s, including mob violence, arrest and the refusal of the authorities to protect them.', 'The Freedom Rides took place in the American South during the year 1961.', 'Jim Zwerg was one of only ten white male student Freedom Riders.', 'There were many buses travelling across the United States during the 1960s.'], c: 0, fb: 'A topic sentence must answer the question and set up an argument. Only the first names the challenges the riders faced. The others are facts or background.'},
  {id: 'q18', src: 'para', num: '3.6b', m: 2, t: 'Which piece of source evidence best supports the topic sentence about the challenges the riders faced?', lv: 3, ll: 'Synthesis', opts: ['Source 3D shows the riders were injured in a bus explosion and then refused treatment at the hospital while a mob gathered outside.', 'Source 3A mentions that the book was written by the activist R Arsenault.', 'Source 3B was published in the New York Amsterdam News in the year 1961.', 'Source 3C notes that Zwerg boarded a bus from Nashville to New Orleans.'], c: 0, fb: 'Good evidence connects to the claim. Source 3D shows the injuries and denial of care the riders faced. The others are publication or biographical details.'},
  {id: 'q19', src: 'para', num: '3.6c', m: 2, t: 'Which piece of your own knowledge best strengthens the argument about the challenges faced by the Freedom Riders?', lv: 3, ll: 'Synthesis', opts: ['Despite beatings, firebombed buses and jail, the Freedom Riders pressed on and forced the government to ban segregation in interstate travel.', 'The Berlin Wall was built in 1961 to stop East Germans from fleeing to the West.', 'The United Nations was founded in 1945 to help maintain international peace.', 'Angola gained its independence from Portugal in the year 1975.'], c: 0, fb: 'Own knowledge must fit the topic. The beatings, burnings and jailings, and the eventual ban on segregation, show the challenges and their result. The others belong to different topics.'},
  {id: 'q20', src: 'para', num: '3.6d', m: 2, t: 'Choose the best concluding sentence that synthesises the paragraph\'s argument.', lv: 3, ll: 'Synthesis', opts: ['In this way, the Freedom Riders overcame violence and official hostility to expose segregation and push for change.', 'Therefore, the Freedom Riders faced no real difficulties at all on their journey.', 'As a result, the Freedom Riders gave up and abandoned their whole campaign.', 'This shows that the Freedom Rides were mainly a peaceful holiday trip.'], c: 0, fb: 'A conclusion should draw the argument together. The first ties the challenges to the riders\' courage and impact. The others contradict the evidence.'},
];

const MTA_ANSWERS = [
  {label: 'Answer A', text: 'The Freedom Riders faced many challenges in the 1960s. They were attacked by people who did not want them to travel together on the buses. Source 3D says that they were injured and that the hospital would not help them. They were also arrested by the police during their journey. Because of these challenges, the Freedom Riders had a very difficult and dangerous time.', expLv: 0, expM: '?-5', crit: [{q: 'Does it have a clear topic sentence addressing the question?', cor: 'partial', exp: 'It says there were \'many challenges\' but does not clearly name them, so the topic is loosely framed.'}, {q: 'Does it use specific evidence from the sources?', cor: 'partial', exp: 'It refers to Source 3D but only generally, without the specific detail of the bus explosion or the mob.'}, {q: 'Does it include own knowledge beyond the sources?', cor: 'no', exp: 'It stays inside the sources. There is no outside fact such as the ban on segregation in interstate travel.'}, {q: 'Does it explain WHY (analysis), not just WHAT (description)?', cor: 'no', exp: 'It lists the challenges rather than analysing how they threatened the riders and the movement.'}, {q: 'Does it have a concluding sentence that synthesises?', cor: 'partial', exp: 'The last sentence restates that it was difficult but does not pull the argument together.'}, {q: 'Is it a coherent paragraph, not a list of disconnected sentences?', cor: 'yes', exp: 'The sentences follow on from one another and read as a connected paragraph.'}]},
  {label: 'Answer B', text: 'The Freedom Riders of the 1960s faced brutal and dangerous challenges as they protested against segregation. As Source 3D describes, their bus was firebombed, leaving them injured from smoke and flying glass, and the hospital then refused to treat them while an angry mob gathered outside. Source 3C adds that riders like Jim Zwerg were arrested by the police simply for sitting together on a bus. Beyond the sources, Governor Patterson and other officials openly withdrew police protection, leaving the riders exposed to Ku Klux Klan violence. Despite beatings, burning buses and jail, the Freedom Riders pressed on and forced the federal government to ban segregation in interstate travel.', expLv: 0, expM: '?-8', crit: [{q: 'Does it have a clear topic sentence addressing the question?', cor: 'yes', exp: 'The first sentence states directly that the riders faced brutal, dangerous challenges.'}, {q: 'Does it use specific evidence from the sources?', cor: 'yes', exp: 'It uses Source 3D (the firebombed bus and refused treatment) and Source 3C (the arrests) with real detail.'}, {q: 'Does it include own knowledge beyond the sources?', cor: 'yes', exp: 'It adds the withdrawal of police protection and the eventual ban on segregation in interstate travel.'}, {q: 'Does it explain WHY (analysis), not just WHAT (description)?', cor: 'yes', exp: 'It explains how official hostility exposed the riders to violence yet failed to stop them, beyond mere description.'}, {q: 'Does it have a concluding sentence that synthesises?', cor: 'yes', exp: 'The closing sentence ties the challenges to the riders\' persistence and their impact.'}, {q: 'Is it a coherent paragraph, not a list of disconnected sentences?', cor: 'yes', exp: 'It flows logically from claim to evidence to own knowledge to conclusion.'}]},
];
...
const KR_META = {interactiveId: 'history-p1-2023-nov-q3', paper: 'P1', section: 'A', questionNumber: 3, paperRef: 'DBE November 2023'};
