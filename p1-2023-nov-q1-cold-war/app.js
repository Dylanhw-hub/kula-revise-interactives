...
const SRC = {
  '1A': {
    ...
    html: `<div class="sp-body">Even before the guns of war were silenced, the European Advisory Commission &ndash; a group formed by the United States, Britain and the Soviet Union &ndash; had begun to plan for the occupation of Germany. At that time, it was decided that Germany would be divided into three zones, one for each country, except France.<br><br>Later at a conference held in February 1945 at Yalta, US President Franklin D Roosevelt and the British Prime Minister Winston Churchill were able to convince Joseph Stalin, the Soviet leader, to create a zone for France, which had suffered three invasions and two defeats at the hands of Germany within seventy years. Each of these four zones would be administered by the country occupying the area.<br><br>On 17 July 1945 Truman, Churchill and Stalin met at Potsdam near Berlin. It was at this meeting that the final decisions were made regarding how Germany should be organised and where its borders would be drawn. Each occupying country had to ensure that the Germans were not able to build up a military force again.<br><br>The city of Berlin, 110 miles inside the eastern zone of the Soviets, became a special area for joint four-power control &hellip; Before the Soviet Army officially took control of its zone, there was a last-minute rush of people from east to west. They feared that the Russians would establish a more secure border, one that would be impossible to get through.</div>`,
    attr: 'From The Berlin Wall: How It Rose and Why It Fell by DM Epler (1992)'
  },
  '1B': {
    label: 'Source 1B',
    type: 'Government Report',
    html: `<div class="sp-body">The Governments of the United States, the United Kingdom and France decided to make formal representations to the government of the USSR. The Soviet Government was informed that the United States regarded the blockade measures as a 'clear violation of existing agreements concerning the administration of Berlin by the four occupying powers'.<br><br>The United States Government categorically (firmly) asserted that it was in occupation of its sector of Berlin with free access thereto 'as a matter of established right derived from the defeat and surrender of Germany and confirmed by formal agreements among the principal Allies'.<br><br>The United States also emphatically (forcefully) declared that it would 'not be induced (pushed) by threats, pressures or other actions to abandon these rights'.<br><br>This consideration, together with responsibility for the physical well-being of the population of its sector of Berlin, including hundreds of thousands of women and children, obliged (forced) the United States to insist that 'in accordance with existing agreements the arrangements for the movement of freight and passenger traffic between the western zones and Berlin be fully restored'.<br><br>The United States emphasised again its willingness to settle by negotiation, or by any of the other peaceful methods provided for in article 33 of the Charter of the United Nations.</div>`,
    attr: 'From The Berlin Crisis: A Report on the Moscow Discussions, 1948 (US Department of State, 6 July 1948)'
  },
  '1C': {
    label: 'Source 1C',
    type: 'Government Report',
    html: `<div class="sp-body">Berlin lies in the centre of the Soviet zone and is part of that zone. The interests of the Berlin population do not permit a situation in which, in Berlin or only in the western sectors of Berlin, there shall be introduced special currency which has no validity in the Soviet zone. Moreover, the carrying out of a separate monetary (financial) reform in the western zones of Germany has placed Berlin and the whole Soviet zone of occupation in a situation in which the entire mass of currency notes, which were cancelled in the western zone, threatened to pour into Berlin and the Soviet zone of occupation of Germany.<br><br>The Soviet Command has been forced, therefore, to adopt certain urgent measures for the protection of the interests of the German population and also of the economy of the Soviet zone of occupation and the area of 'Greater Berlin'. The danger of the disruption of the economic activity of the Soviet zone and of Berlin has not been eliminated even at the present time, in as much as the United States, Great Britain and France continue to maintain in Berlin their special currency.<br><br>Furthermore, the Soviet Command has consistently displayed and is displaying concern for the well-being of the Berlin population and is assuring them of normal supply in all essentials.</div>`,
    attr: 'Soviet Union response of 14 July 1948, from The Berlin Crisis: A Report on the Moscow Discussions, 1948'
  },
  '1D': {
    label: 'Source 1D',
    type: 'Political Cartoon',
    html: `<img class="sp-img" src="1D.png" alt="A black-and-white cartoon titled 'Unter den Linden'. Three Western figures in top hats and formal dress (labelled USA, France and Britain) sit close together on a circular bench around a large tree labelled 'BERLIN'. On the right, a grinning figure of Stalin, in a cap and boots, saws through the 'Berlin' tree trunk with a large saw. A signpost reads 'RUSSIAN AGREEMENT TO MEDIATE'."><div class="sp-body" style="margin-top:12px;">Caption: 'Russian Agreement to Mediate' &ndash; Russia (Stalin) having the final say in ending Allied joint administration of Berlin.</div>`,
    attr: 'Cartoon \'Unter den Linden\' by S.J. Ray, Kansas City Star, 2 December 1948'
  },
  'compare': {
    label: 'Sources 1B + 1C',
    type: 'Comparison',
    html: `<div class="sp-body"><strong>Source 1B (the US view)</strong><br><br>&hellip; the United States regarded the blockade measures as a 'clear violation of existing agreements concerning the administration of Berlin' &hellip; it was in occupation of its sector 'as a matter of established right derived from the defeat and surrender of Germany and confirmed by formal agreements among the principal Allies' &hellip; it would 'not be induced by threats, pressures or other actions to abandon these rights'.</div><div class="sp-body" style="margin-top:12px;"><strong>Source 1C (the Soviet view)</strong><br><br>Berlin lies in the centre of the Soviet zone and is part of that zone &hellip; The Soviet Command has been forced &hellip; to adopt certain urgent measures for the protection of the interests of the German population and also of the economy of the Soviet zone of occupation &hellip;</div>`,
    attr: 'Re-read both sources, then explain how they differ.'
  },
  'para': {
    label: 'Paragraph Task',
    type: 'Q1.6, 8 marks',
    html: `<div class="sp-body">Now build an eight-mark paragraph answering the guiding question: <em>How did Berlin become a focal point of Cold War tension between the USSR and the USA in 1948?</em><br><br>Work through it in four steps &ndash; a topic sentence, evidence from the sources, your own knowledge, and a synthesising conclusion. Choose the strongest option at each step.</div>`,
...
const QS = [
  {id: 'q1', src: '1A', num: '1.1.1', m: 3, t: 'Identify in the source the THREE countries that made up the European Advisory Commission. Choose THREE responses.', lv: 1, ll: 'Extraction', multi: true, mx: 3, opts: ['The United States', 'Britain', 'The Soviet Union', 'France', 'Germany', 'Poland'], c: [0, 1, 2], fb: 'The source says the European Advisory Commission was \'a group formed by the United States, Britain and the Soviet Union\'. France was only later given a zone; Germany and Poland were not members.'},
  {id: 'q2', src: '1A', num: '1.1.2', m: 1, t: 'Why, according to the source, was it decided at Yalta in February 1945 to also create a zone for France in Germany?', lv: 1, ll: 'Extraction', opts: ['Because France had suffered three invasions and two defeats by Germany within seventy years.', 'Because France had the largest and strongest army among all the Allied powers.', 'Because France had never once been occupied by Nazi Germany during the war.', 'Because the Soviet Union firmly demanded that France be given its own zone.'], c: 0, fb: 'The source says France \'had suffered three invasions and two defeats at the hands of Germany within seventy years\'. The other options are not given as the reason.'},
  {id: 'q3', src: '1A', num: '1.1.3', m: 2, t: 'Explain why you think the occupying countries had \'to ensure that the Germans were not able to build up a military force again\'.', lv: 2, ll: 'Interpretation', opts: ['To prevent Germany from rearming and starting another devastating war, as it had twice in living memory.', 'To make sure that Germany could quickly rejoin the fighting on the side of the Allies.', 'To allow the Soviet Union to take complete and sole control of the whole of Germany.', 'Because Germany had promised never to build any factories of any kind again.'], c: 0, fb: 'Germany had launched two world wars, so the Allies disarmed it to stop another. The other options reverse or distort that aim.'},
  {id: 'q4', src: '1A', num: '1.1.4', m: 4, t: 'Comment on the implications of having the city of Berlin in the Soviet zone in the context of Cold War tensions between the USSR and the USA in 1948.', lv: 2, ll: 'Interpretation', opts: ['It left the Western-controlled parts of Berlin surrounded by Soviet territory, giving the USSR the power to cut them off and raising tensions.', 'It meant that the Soviet Union had quietly agreed to hand the whole of Berlin over to the USA.', 'It meant that the city of Berlin was completely safe from any disagreement between the superpowers.', 'It showed that the USA had given up all of its remaining interest in the future of Europe.'], c: 0, fb: 'Berlin sat deep inside the Soviet zone, so the West\'s sectors could be encircled and cut off, a constant source of tension. The other options reverse the situation.'},
  {id: 'q5', src: '1B', num: '1.2.1', m: 2, t: 'Define the term blockade in your own words.', lv: 1, ll: 'Concept', opts: ['The sealing off of an area to stop people, supplies or traffic from getting in or out.', 'An agreement between countries to trade their goods freely without any taxes.', 'A military alliance that is formed to defend its member states against attack.', 'A vote taken by the United Nations in order to settle a dispute peacefully.'], c: 0, fb: 'A blockade seals off an area to cut off movement and supplies. The other options describe free trade, an alliance and a UN vote.'},
  {id: 'q6', src: '1B', num: '1.2.2', m: 4, t: 'Explain why you think the USA regarded the Berlin Blockade as \'a clear violation of existing agreements concerning the administration of Berlin\'.', lv: 2, ll: 'Interpretation', opts: ['The four powers had agreed to govern Berlin jointly with free access, so blocking the Western sectors broke those agreements.', 'The USA had never signed any agreement at all with the Soviet Union about the city of Berlin.', 'The blockade was actually fully allowed under the agreements the four powers made at Potsdam.', 'The Soviet Union had politely asked the USA\'s permission before starting the Berlin Blockade.'], c: 0, fb: 'Berlin was meant to be jointly governed with free access, so sealing off the West broke the agreements. The other options deny the agreements or excuse the blockade.'},
  {id: 'q7', src: '1B', num: '1.2.3', m: 3, t: 'Quote THREE reasons from the source why the USA was determined to remain as a power in Berlin. Choose THREE responses.', lv: 1, ll: 'Extraction', multi: true, mx: 3, opts: ['It was an established right derived from the defeat and surrender of Germany', 'It was confirmed by formal agreements among the principal Allies', 'It would not be pushed by threats or pressures to abandon these rights', 'The Soviet Union had invited the USA to remain in Berlin', 'Berlin held valuable gold reserves the USA wanted to control', 'The USA wanted to build new military bases across Eastern Europe'], c: [0, 1, 2], fb: 'The source gives the right from Germany\'s defeat, confirmation by formal Allied agreements, and refusal to be pushed out by threats. The other options are not in the source.'},
  {id: 'q8', src: '1B', num: '1.2.4', m: 1, t: 'State ONE specific obligation, according to the source, which the USA insisted on concerning the physical well-being of the population of its sector in Berlin.', lv: 1, ll: 'Extraction', opts: ['That freight and passenger traffic between the western zones and Berlin be fully restored.', 'That all of the Soviet troops be withdrawn from the city of Berlin.', 'That a new special currency be introduced across the whole Soviet zone.', 'That the four powers immediately stop governing Berlin together.'], c: 0, fb: 'For the population\'s well-being the USA insisted \'that ... the movement of freight and passenger traffic between the western zones and Berlin be fully restored\'. The other options are not in the source.'},
  {id: 'q9', src: '1B', num: '1.2.5', m: 4, t: 'Comment on why the USA emphasised its willingness to settle any disagreements with the USSR by negotiations.', lv: 2, ll: 'Interpretation', opts: ['To show it wanted a peaceful solution and to avoid war, while still refusing to give up its rights in Berlin.', 'To prove to the world that it was far too weak to stand up to the Soviet Union militarily.', 'To signal that it had already decided to abandon its sector of Berlin to the USSR.', 'To warn the USSR that it was about to launch a full-scale military invasion.'], c: 0, fb: 'Stressing negotiation showed the USA sought peace and wanted to avoid war, without surrendering its rights. The other options misread it as weakness, surrender or a war threat.'},
  {id: 'q10', src: '1C', num: '1.3.1', m: 2, t: 'Give TWO reasons, according to the source, why the Soviet Union opposed the introduction of a special currency to be used in the western part of Berlin only. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['The special currency had no validity in the Soviet zone', 'Cancelled western currency notes threatened to pour into the Soviet zone', 'The special currency was printed only in the Russian language', 'The USA refused to share the new currency with the Soviets', 'The currency would make the Soviet zone become far too wealthy'], c: [0, 1], fb: 'The source objects that the currency \'has no validity in the Soviet zone\' and that cancelled western notes \'threatened to pour into ... the Soviet zone\'. The other options are not stated.'},
  {id: 'q11', src: '1C', num: '1.3.2', m: 2, t: 'Explain the concept monetary reform in the context of the Berlin zones in 1948.', lv: 2, ll: 'Concept', opts: ['The introduction of a new currency to reorganise and stabilise the economy, here a separate one in the western zones.', 'The joining together of all four zones into a single shared economy and government.', 'The removal of all money from Berlin so that goods were simply swapped for other goods.', 'A Soviet plan to hand out free food supplies to the whole of the Berlin population.'], c: 0, fb: 'Monetary reform means bringing in a new currency to reorganise the economy; here the West did so separately, which alarmed the Soviets. The other options are unrelated.'},
  {id: 'q12', src: '1C', num: '1.3.3', m: 2, t: 'Why, according to the source, did the Soviet Command believe that the danger of the disruption of economic activities of the Soviet zone and of Berlin was not eliminated?', lv: 1, ll: 'Extraction', opts: ['Because the USA, Britain and France continued to maintain their special currency in Berlin.', 'Because the Soviet zone had already run completely out of all food supplies.', 'Because the Western powers had agreed to withdraw from Berlin entirely.', 'Because Berlin lay 110 miles outside of the Soviet zone of occupation.'], c: 0, fb: 'The source says the danger remained \'in as much as the United States, Great Britain and France continue to maintain in Berlin their special currency\'. The other options are not given.'},
  {id: 'q13', src: '1C', num: '1.3.4', m: 4, t: 'Comment on the limitations of this source to a historian researching the division of Berlin.', lv: 3, ll: 'Reliability', opts: ['It gives only the Soviet side and justifies Soviet actions, so it presents a one-sided, biased view of the division.', 'It is limited because it was written many centuries before the division of Berlin took place.', 'It is limited because it gives a fully balanced account from both the Soviet and Western sides.', 'It is limited because it contains detailed statistics that no historian is able to check.'], c: 0, fb: 'As an official Soviet note it gives only Moscow\'s side and justifies the blockade, so it is one-sided. The other options invent a wrong date, false balance, or statistics that are not there.'},
  {id: 'q14', src: 'compare', num: '1.4', m: 4, t: 'Consult Sources 1B and 1C. Comment on how Source 1B differs from Source 1C regarding the reasons given by the USA and the Soviet Union for remaining as occupying powers in Berlin in 1948.', lv: 3, ll: 'Comparison', opts: ['1B says the USA stayed by right from Germany\'s defeat and formal agreements, while 1C says the USSR acted to protect the Soviet zone\'s economy and population.', 'They give the same reason: both say they stayed only in order to protect the Berlin population from hunger.', '1B and 1C agree that neither power really had any right at all to remain in the city of Berlin.', '1B focuses on the Soviet economy while 1C focuses on the Allied agreements made during the war.'], c: 0, fb: '1B bases the US claim on rights and Allied agreements; 1C bases the Soviet claim on protecting its zone\'s economy and people. The other options claim they are the same or swap the two sides.'},
  {id: 'q15', src: '1D', num: '1.5.1', m: 2, t: 'Explain the symbolic representation of the three leaders seated next to each other in the context of the Cold War.', lv: 2, ll: 'Interpretation', opts: ['They represent the Western Allies (USA, Britain and France) united together in the joint administration of Berlin.', 'They represent the Soviet Union, China and Cuba forming a united communist bloc.', 'They represent three defeated German generals waiting to surrender to the Allies.', 'They represent neutral countries that refused to take any side in the Cold War.'], c: 0, fb: 'The three seated figures are the Western Allies, USA, Britain and France, shown together as the joint occupiers of Berlin. The other options misidentify them.'},
  {id: 'q16', src: '1D', num: '1.5.2', m: 2, t: 'Why did Russia (Stalin) want to have a final say in the administration of Berlin?', lv: 2, ll: 'Interpretation', opts: ['To gain control over Berlin and weaken the Western Allies\' position, dividing the city to Soviet advantage.', 'To hand the whole of the city of Berlin over peacefully to the Western Allies.', 'To make sure that Berlin remained equally and fairly shared among all four powers.', 'To help the United States rebuild the German economy far more quickly.'], c: 0, fb: 'Stalin wanted the upper hand in Berlin, dividing it to Soviet advantage, as the cartoon\'s sawing of the \'Berlin\' tree suggests. The other options reverse his aim.'},
  {id: 'q17', src: 'para', num: '1.6a', m: 2, t: 'Choose the best topic sentence for a paragraph explaining how Berlin became a focal point of Cold War tension between the USSR and the USA in 1948.', lv: 3, ll: 'Synthesis', opts: ['Berlin became a Cold War flashpoint in 1948 as the USSR and USA clashed over the divided city.', 'Berlin was a large city that lay some 110 miles inside the Soviet zone of Germany.', 'The Second World War finally came to an end in Europe during the year 1945.', 'There were four different occupying powers involved in the administration of Germany.'], c: 0, fb: 'A topic sentence must answer the question and set up an argument. Only the first states how Berlin became a flashpoint. The others are facts or background.'},
  {id: 'q18', src: 'para', num: '1.6b', m: 2, t: 'Which piece of source evidence best supports the topic sentence about Berlin becoming a Cold War flashpoint?', lv: 3, ll: 'Synthesis', opts: ['Source 1B shows the USA condemning the blockade as a violation of agreements and refusing to abandon its rights in Berlin.', 'Source 1A mentions that France had suffered three invasions by Germany in seventy years.', 'Source 1C states that the Soviet note was dated the 14th of July in 1948.', 'Source 1D was drawn by the cartoonist S.J. Ray for an American newspaper.'], c: 0, fb: 'Good evidence connects to the claim. Source 1B shows the direct US-Soviet clash over Berlin. The others are background, a date, or an irrelevant detail.'},
  {id: 'q19', src: 'para', num: '1.6c', m: 2, t: 'Which piece of your own knowledge best strengthens the argument about Berlin and Cold War tension in 1948?', lv: 3, ll: 'Synthesis', opts: ['In response to the blockade, the USA and Britain launched the Berlin Airlift, flying in supplies for almost a year.', 'The Berlin Wall was built in 1961 to stop East Germans from fleeing to the West.', 'The United Nations was founded in 1945 to help maintain international peace.', 'The Cuban Missile Crisis brought the superpowers close to nuclear war in 1962.'], c: 0, fb: 'Own knowledge must fit 1948. The Berlin Airlift was the direct Western response to the blockade. The others belong to different years or topics.'},
  {id: 'q20', src: 'para', num: '1.6d', m: 2, t: 'Choose the best concluding sentence that synthesises the paragraph\'s argument.', lv: 3, ll: 'Synthesis', opts: ['In this way, the blockade and the rival claims over Berlin turned the city into an early flashpoint of the Cold War.', 'Therefore, the USSR and the USA remained close and trusting allies well after 1948.', 'As a result, the four powers went on to govern the city of Berlin together in complete harmony.', 'This shows that the Berlin crisis of 1948 had nothing at all to do with the Cold War.'], c: 0, fb: 'A conclusion should draw the argument together. The first ties the blockade and rival claims into Berlin\'s role as a Cold War flashpoint. The others contradict the evidence.'},
];

const MTA_ANSWERS = [
  {label: 'Answer A', text: 'Berlin became a focal point of Cold War tension in 1948. The city was divided between the Soviet Union and the Western powers. The Soviet Union blockaded Berlin and this caused a lot of problems. Source 1B shows that the USA was angry about the blockade. The two sides did not agree with each other about who should control Berlin, so tension grew between them at this time.', expLv: 0, expM: '?-5', crit: [{q: 'Does it have a clear topic sentence addressing the question?', cor: 'partial', exp: 'It names Berlin and tension but does not set out HOW the tension arose, so the topic is loosely framed.'}, {q: 'Does it use specific evidence from the sources?', cor: 'partial', exp: 'It refers to Source 1B but only generally (\'the USA was angry\'), without the specific detail about violated agreements.'}, {q: 'Does it include own knowledge beyond the sources?', cor: 'no', exp: 'It stays inside the sources. There is no outside fact such as the Berlin Airlift or the 1949 lifting of the blockade.'}, {q: 'Does it explain WHY (analysis), not just WHAT (description)?', cor: 'no', exp: 'It mostly describes the division and the blockade rather than explaining why they created tension.'}, {q: 'Does it have a concluding sentence that synthesises?', cor: 'partial', exp: 'The last sentence restates that tension grew but does not pull the argument together.'}, {q: 'Is it a coherent paragraph, not a list of disconnected sentences?', cor: 'yes', exp: 'The sentences follow on from one another and read as a connected paragraph.'}]},
  {label: 'Answer B', text: 'Berlin became a focal point of Cold War tension in 1948 because the wartime allies could not agree on how to control the divided city. As Source 1B shows, when the Soviet Union blockaded the western sectors, the USA condemned it as a clear violation of the four-power agreements and refused to abandon its rights. Source 1C reveals the Soviet side, justifying the blockade as protection for its zone against the new western currency. Beyond the sources, the USA and Britain responded with the Berlin Airlift, flying in supplies for nearly a year until Stalin lifted the blockade in 1949. Trapped inside the Soviet zone, Berlin became the first great trial of strength between East and West.', expLv: 0, expM: '?-8', crit: [{q: 'Does it have a clear topic sentence addressing the question?', cor: 'yes', exp: 'The first sentence states directly that Berlin became a flashpoint because the allies could not agree on control of the city.'}, {q: 'Does it use specific evidence from the sources?', cor: 'yes', exp: 'It uses Source 1B (violation of agreements) and Source 1C (the Soviet justification) with real detail.'}, {q: 'Does it include own knowledge beyond the sources?', cor: 'yes', exp: 'It adds the Berlin Airlift and the lifting of the blockade in 1949, accurate facts from beyond the sources.'}, {q: 'Does it explain WHY (analysis), not just WHAT (description)?', cor: 'yes', exp: 'It explains why the rival claims and the blockade produced tension, moving beyond description into cause.'}, {q: 'Does it have a concluding sentence that synthesises?', cor: 'yes', exp: 'The closing sentence ties the argument together, casting Berlin as the first trial of strength between East and West.'}, {q: 'Is it a coherent paragraph, not a list of disconnected sentences?', cor: 'yes', exp: 'It flows logically from claim to evidence to own knowledge to conclusion.'}]},
];
...
const KR_META = {interactiveId: 'history-p1-2023-nov-q1', paper: 'P1', section: 'A', questionNumber: 1, paperRef: 'DBE November 2023'};
