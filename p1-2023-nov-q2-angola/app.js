...
const QS = [
  ...
  {id: 'q5', src: '2B', num: '2.2.1', m: 4, t: 'Why do you think this photograph was taken in December 1975?', lv: 2, ll: 'Interpretation', opts: ['To record MPLA soldiers fighting in the Angolan Civil War, documenting the movement\'s armed role around independence.', 'To celebrate a peace agreement signed between the three rival nationalist movements.', 'To show Portuguese troops handing over power peacefully to the Angolan people.', 'To advertise the Angolan army\'s great victory over the Soviet Union.'], c: 0, fb: 'The photograph documents armed MPLA soldiers in the civil war at the time of independence. The other options misidentify the scene.'},
