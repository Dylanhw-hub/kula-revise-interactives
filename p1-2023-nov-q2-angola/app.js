...
const SRC = {
  '2A': {
    ...
    html: `<div class="sp-body">Following the Carnation Revolution in Portugal during April 1974 (which deposed Salazar's successor Marcelo Caetano), three political factions vied (contested) for Angolan power. One of the three was the Popular Movement for the Liberation of Angola (MPLA), to which Agostinho Neto belonged. On 11 November 1975, Angola achieved full independence from the Portuguese, and Neto became the nation's ruler after the MPLA seized Luanda at the expense of the other liberation movements. He established a one-party state and his government developed close links with the Soviet Union and other nations in the Eastern bloc and other communist states, particularly Cuba, which aided the MPLA considerably in its war with the National Front for the Liberation of Angola (FNLA), the National Union for the Total Independence of Angola (UNITA) and South Africa.<br><br>&hellip; As a consequence, he violently repressed (suppressed) a movement later called Fractionism, which in 1977 attempted a coup d'&eacute;tat (overthrowing an existing government). Tens of thousands of followers (or alleged followers) of Nito Alves were executed in the aftermath of the attempted coup, over a period that lasted up to two years.</div>`,
    attr: 'From a biographical article on Agostinho Neto (kwekudee-tripdownmemorylane blog), accessed 22 March 2023'
  },
  '2B': {
    label: 'Source 2B',
    type: 'Photograph',
    html: `<img class="sp-img" src="2B.png" alt="A black-and-white photograph from December 1975 of a group of armed MPLA soldiers standing in a street, holding rifles, with a military truck behind them."><div class="sp-body" style="margin-top:12px;">Titled 'Angola's Brutal History and the MPLA's Role in it'. It depicts soldiers of the MPLA who fought in the Angolan Civil War.</div>`,
    attr: 'From the Guardian newspaper, 5 May 2014; photograph taken December 1975'
  },
  '2C': {
    label: 'Source 2C',
    type: 'Historical Account',
    html: `<div class="sp-body">The transition (change) from Portuguese rule in Angola turned into a disaster on a far greater scale. The withdrawal of the Portuguese abandoned all attempts to control the transition. On the eve of independence in November 1975, with much of the country engulfed (destroyed) in violence, the Portuguese High Commissioner, Admiral Leonel Cardoso, held a brief ceremony in Luanda at which he announced that he was transferring power to the 'Angolan people'. Not a single Angolan was present to witness the proceedings.<br><br>No serious effort was ever made by the nationalists to reconcile their differences. The race for power in Angola from the outset was conducted more in terms of an armed struggle than through political bargaining. At every stage in the conflict, each faction tried to gain advantage by appealing for support from foreign interests. The two principal foreign powers involved in the conflict, the United States and the Soviet Union, had no direct strategic interest in Angola. But both were determined for reasons of their own prestige and because of their preoccupation (concern) with the global balance of power, to ensure that the Angolan factions they supported were triumphant (successful).</div>`,
    attr: 'From The First Dance of Freedom: Black Africa in the Post-War Era by M Meredith'
  },
  '2D': {
    label: 'Source 2D',
    type: 'Historical Account',
    html: `<div class="sp-body">The Popular Movement for the Liberation of Angola (MPLA), led by Agostinho Neto, looked upon politics through nationalist and socialist lenses. Others, however, saw its leaders as mulattos* who were removed from the social institutions and networks in which most people lived. Meanwhile, Bakongo living on the Angolan side of the border with the Belgian Congo organised the National Front for the Liberation of Angola (FNLA) under Holden Roberto. Then came the National Union for the Total Liberation of Angola (UNITA), organised by Jonas Savimbi, who was from the Ovimbundu-speaking region. His small cadre of followers, mostly from Protestant mission schools, had a thoroughly rural base. Conflict became ethnicised (culturally based).<br><br>The FNLA was supported by Zaire and the Central Intelligence Agency (CIA), which saw it as the least Marxist of the three &hellip; UNITA had support from Zambia and then from South Africa. Savimbi flipped (reversed) his ideological stance from Maoism to Reaganism with scarcely the blink of an eye and the United States added its support to UNITA &hellip;<br><br>The MPLA combined the features of a Soviet party and the African gatekeeper state. Its real source of power was oil revenue, and after gestures at revolutionising agriculture, it did little in the countryside other than recruit soldiers. Education, health and other services in the cities languished (suffered).</div>`,
    attr: 'From Africa since 1940: The Past of the Present by F Cooper'
  },
  'compare': {
    label: 'Sources 2C + 2D',
    type: 'Comparison',
    html: `<div class="sp-body"><strong>Source 2C</strong><br><br>&hellip; No serious effort was ever made by the nationalists to reconcile their differences. The race for power in Angola from the outset was conducted more in terms of an armed struggle than through political bargaining. At every stage in the conflict, each faction tried to gain advantage by appealing for support from foreign interests. &hellip;</div><div class="sp-body" style="margin-top:12px;"><strong>Source 2D</strong><br><br>&hellip; Conflict became ethnicised. The FNLA was supported by Zaire and the CIA &hellip; UNITA had support from Zambia and then from South Africa &hellip; the United States added its support to UNITA &hellip; [while the MPLA developed] the features of a Soviet party.</div>`,
    attr: 'Re-read both sources, then explain how they connect.'
  },
  'para': {
    label: 'Paragraph Task',
    type: 'Q2.6, 8 marks',
    html: `<div class="sp-body">Now build an eight-mark paragraph answering the guiding question: <em>What factors led to the three nationalist movements (MPLA, FNLA and UNITA) becoming involved in the Angolan Civil War in 1975?</em><br><br>Work through it in four steps &ndash; a topic sentence, evidence from the sources, your own knowledge, and a synthesising conclusion. Choose the strongest option at each step.</div>`,
...
const QS = [
  {id: 'q1', src: '2A', num: '2.1.1', m: 2, t: 'Define the term revolution in your own words.', lv: 1, ll: 'Concept', opts: ['A sudden, often violent, overthrow of a government or social order to bring about major change.', 'A peaceful agreement between two countries to share power and their territory.', 'A gradual reform of laws passed slowly through a country\'s parliament.', 'A military alliance formed to defend its member states against attack.'], c: 0, fb: 'A revolution is a sudden, often violent overthrow bringing major change (as in Portugal\'s Carnation Revolution). The other options describe an agreement, gradual reform or an alliance.'},
  {id: 'q2', src: '2A', num: '2.1.2', m: 3, t: 'Identify in the source the THREE nationalist movements that contested the control of Angola after independence. Choose THREE responses.', lv: 1, ll: 'Extraction', multi: true, mx: 3, opts: ['The MPLA', 'The FNLA', 'UNITA', 'The ANC', 'SWAPO', 'FRELIMO'], c: [0, 1, 2], fb: 'The source names the MPLA, the FNLA and UNITA as the three factions contesting Angola. The ANC, SWAPO and FRELIMO were movements in other countries.'},
  {id: 'q3', src: '2A', num: '2.1.3', m: 2, t: 'Name TWO communist countries in the source with which Neto formed close links. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['The Soviet Union', 'Cuba', 'The United States', 'Portugal', 'South Africa'], c: [0, 1], fb: 'The source says Neto\'s government formed close links with the Soviet Union and \'particularly Cuba\'. The others were not communist allies of the MPLA.'},
  {id: 'q4', src: '2A', num: '2.1.4', m: 2, t: 'What does the execution of Nito Alves\' followers suggest about Neto\'s leadership?', lv: 2, ll: 'Interpretation', opts: ['That Neto ruled harshly and would violently crush any opposition or threat to his one-party rule.', 'That Neto was a gentle leader who happily tolerated all political disagreement.', 'That Neto had no real control over the government of Angola at all.', 'That Neto shared power equally with both the FNLA and UNITA.'], c: 0, fb: 'Executing tens of thousands of alleged opponents shows harsh, authoritarian rule that crushed opposition. The other options reverse or deny this.'},
  {id: 'q5', src: '2B', num: '2.2.1', m: 4, t: 'Why do you think this photograph was taken in December 1975?', lv: 2, ll: 'Interpretation', opts: ['To display and consolidate the MPLA\'s power over rival nationalist movements and celebrate its victory.', 'To celebrate a peace agreement signed between the three rival nationalist movements.', 'To show Portuguese troops handing over power peacefully to the Angolan people.', 'To advertise the Angolan army\'s great victory over the Soviet Union.'], c: 0, fb: 'The photograph was taken to display and consolidate the MPLA\'s power over rival nationalist movements, intimidate its rivals and celebrate its victory at the time of independence. The other options misidentify the scene.'},
  {id: 'q6', src: '2B', num: '2.2.2', m: 2, t: 'Comment on the implication of the title of the photograph, \'Angola\'s Brutal History and the MPLA\'s Role in it\'.', lv: 2, ll: 'Interpretation', opts: ['It suggests Angola\'s past was violent and that the MPLA was itself part of that brutality, not just a victim.', 'It suggests that the MPLA brought lasting peace and prosperity to the whole of Angola.', 'It suggests that Angola had no history of any violence before the MPLA existed.', 'It suggests that the MPLA played no part at all in the country\'s many conflicts.'], c: 0, fb: 'The title implies a violent past in which the MPLA was an active participant. The other options reverse or deny the MPLA\'s role.'},
  {id: 'q7', src: '2C', num: '2.3.1', m: 2, t: 'Why, according to the source, did the transition from Portuguese rule in Angola turn into a disaster?', lv: 1, ll: 'Extraction', opts: ['Because the withdrawing Portuguese abandoned all attempts to control the transition of power.', 'Because the three movements peacefully agreed to share power in Angola.', 'Because the United Nations took full control of the country\'s transition.', 'Because South Africa immediately granted Angola its full independence.'], c: 0, fb: 'The source says \'the withdrawal of the Portuguese abandoned all attempts to control the transition\'. The other options are not in the source.'},
  {id: 'q8', src: '2C', num: '2.3.2', m: 2, t: 'Explain the term civil war in the context of the contestation of power over Angola.', lv: 2, ll: 'Concept', opts: ['A war fought between opposing groups within the same country for control of the state.', 'A war fought between two different independent nations over disputed territory.', 'A peaceful contest for power that is settled through free national elections.', 'A military alliance of several countries formed against a common enemy.'], c: 0, fb: 'A civil war is fought between rival groups inside one country, as the MPLA, FNLA and UNITA did over Angola. The other options describe a war between nations, an election or an alliance.'},
  {id: 'q9', src: '2C', num: '2.3.3', m: 4, t: 'Comment on the meaning of the statement, \'But both were determined for reasons of their own prestige …\', in the context of their involvement in the Angolan Civil War.', lv: 2, ll: 'Interpretation', opts: ['The USA and USSR had no direct interest in Angola but backed rival sides to protect their global prestige and standing.', 'The USA and USSR were fighting each other directly on Angolan soil during the war.', 'The USA and USSR both chose to support exactly the same Angolan movement.', 'The USA and USSR simply wanted to give Angola its independence peacefully.'], c: 0, fb: 'Though neither had a direct interest, both superpowers backed rival factions for prestige and global standing. The other options misstate what they did.'},
  {id: 'q10', src: '2C', num: '2.3.4', m: 4, t: 'Explain the usefulness of this source to a historian studying the Angolan Civil War.', lv: 3, ll: 'Reliability', opts: ['Useful because it is a historian\'s account explaining the roots of the conflict and the motives of the foreign powers involved.', 'Useful because it gives the personal eyewitness account of an MPLA soldier who fought in the war.', 'Not useful because it was written long before the Angolan Civil War had even begun.', 'Not useful because it only lists casualty statistics with no explanation at all.'], c: 0, fb: 'As a historian\'s analysis, the source usefully explains the causes and the superpowers\' motives. The other options misdescribe it.'},
  {id: 'q11', src: '2D', num: '2.4.1', m: 2, t: 'Quote evidence from the source that suggests that the MPLA was leaning towards nationalism and socialism.', lv: 1, ll: 'Extraction', opts: ['\'The MPLA, led by Agostinho Neto, looked upon politics through nationalist and socialist lenses.\'', '\'The FNLA was supported by Zaire and the Central Intelligence Agency (CIA).\'', '\'UNITA had support from Zambia and then from South Africa.\'', '\'Savimbi flipped his ideological stance from Maoism to Reaganism.\''], c: 0, fb: 'The evidence is that the MPLA \'looked upon politics through nationalist and socialist lenses\'. The other quotes are about the FNLA and UNITA.'},
  {id: 'q12', src: '2D', num: '2.4.2', m: 2, t: 'Explain what you think is implied by the following in the context of the Angolan Civil War: \'Conflict became ethnicised\'.', lv: 2, ll: 'Interpretation', opts: ['The war split along ethnic lines, with each movement rooted in a different ethnic or regional group.', 'The conflict was fought only between foreign countries, and not between Angolans at all.', 'The three movements united as a single ethnic group against the Portuguese.', 'Ethnic differences played no part at all in the Angolan conflict.'], c: 0, fb: '\'Ethnicised\' means the conflict divided along ethnic and regional lines, each movement drawing on a different group. The other options reverse this.'},
  {id: 'q13', src: '2D', num: '2.4.3', m: 1, t: 'Why, according to the source, did the Central Intelligence Agency (CIA) support the FNLA?', lv: 1, ll: 'Extraction', opts: ['Because it saw the FNLA as the least Marxist of the three movements.', 'Because the FNLA was the most Marxist of the three movements.', 'Because the FNLA was strongly supported by the Soviet Union.', 'Because the FNLA had already won the Angolan Civil War.'], c: 0, fb: 'The source says the CIA \'saw it as the least Marxist of the three\'. The other options are the opposite or untrue.'},
  {id: 'q14', src: '2D', num: '2.4.4', m: 4, t: 'Using the information in the source and your own knowledge, comment on why you think South Africa decided to support UNITA.', lv: 2, ll: 'Interpretation', opts: ['To oppose the Soviet- and Cuban-backed Marxist MPLA on its border and protect apartheid South Africa\'s regional security.', 'To help the MPLA establish a communist one-party state in the whole of Angola.', 'Because South Africa wanted Angola to remain a Portuguese colony forever.', 'Because the United Nations had ordered South Africa to support UNITA.'], c: 0, fb: 'Apartheid South Africa backed UNITA to counter the Soviet- and Cuban-backed MPLA near its borders. The other options put South Africa on the wrong side or invent a UN order.'},
  {id: 'q15', src: '2D', num: '2.4.5', m: 2, t: 'Quote TWO pieces of evidence from the source that suggest the MPLA did not improve the lives of the Angolan people. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['It did little in the countryside other than recruit soldiers', 'Education, health and other services in the cities languished', 'It built new schools and hospitals across the whole country', 'It shared the country\'s oil revenue equally among the people', 'It quickly ended the war and brought lasting peace'], c: [0, 1], fb: 'The source says the MPLA \'did little in the countryside other than recruit soldiers\' and that \'education, health and other services in the cities languished\'. The others are not stated.'},
  {id: 'q16', src: 'compare', num: '2.5', m: 4, t: 'Refer to Sources 2C and 2D. Explain how the evidence in Source 2C supports the information in Source 2D regarding the approach followed by the three nationalist movements.', lv: 3, ll: 'Comparison', opts: ['Both show the movements pursued armed struggle and sought rival foreign backers rather than uniting, deepening the conflict.', 'They contradict each other: 2C says the movements united while 2D says they fought each other.', 'Both show that the three movements peacefully shared power after independence.', '2C supports 2D by proving that no foreign powers were ever involved in Angola.'], c: 0, fb: 'Both show the movements chose armed struggle and foreign backing over unity, 2C on the failure to reconcile and 2D on the rival foreign supporters. They agree; they do not contradict.'},
  {id: 'q17', src: 'para', num: '2.6a', m: 2, t: 'Choose the best topic sentence for a paragraph explaining what factors led to the three nationalist movements becoming involved in the Angolan Civil War in 1975.', lv: 3, ll: 'Synthesis', opts: ['Several factors drew the MPLA, FNLA and UNITA into civil war in 1975: rivalry for power, ethnic divisions and foreign backing.', 'Angola gained its full independence from Portugal on the 11th of November 1975.', 'The MPLA was led by the nationalist figure Agostinho Neto during the 1970s.', 'There were many different political movements active across Africa during the 1970s.'], c: 0, fb: 'A topic sentence must answer the question and set up an argument. Only the first names the factors behind the war. The others are facts or vague background.'},
  {id: 'q18', src: 'para', num: '2.6b', m: 2, t: 'Which piece of source evidence best supports the topic sentence about the factors leading to the civil war?', lv: 3, ll: 'Synthesis', opts: ['Source 2C shows the movements chose armed struggle over political bargaining and each appealed to foreign powers for support.', 'Source 2A mentions that Angola became independent on the 11th of November 1975.', 'Source 2B is a photograph that appeared in the Guardian newspaper in 2014.', 'Source 2D notes that Savimbi came from the Ovimbundu-speaking region of Angola.'], c: 0, fb: 'Good evidence connects to the claim. Source 2C shows the armed rivalry and foreign appeals that fed the war. The others are background, a publication detail, or an off-point fact.'},
  {id: 'q19', src: 'para', num: '2.6c', m: 2, t: 'Which piece of your own knowledge best strengthens the argument about the factors behind the Angolan Civil War?', lv: 3, ll: 'Synthesis', opts: ['The Cold War turned Angola into a proxy battleground: the USSR and Cuba backed the MPLA while the USA and South Africa backed its rivals.', 'The Berlin Wall was built in 1961 to stop East Germans from fleeing to the West.', 'The United Nations was founded in 1945 to help maintain international peace.', 'Nelson Mandela was released from prison in South Africa in the year 1990.'], c: 0, fb: 'Own knowledge must fit the topic. The Cold War proxy backing directly explains foreign involvement in Angola. The others belong to different topics or times.'},
  {id: 'q20', src: 'para', num: '2.6d', m: 2, t: 'Choose the best concluding sentence that synthesises the paragraph\'s argument.', lv: 3, ll: 'Synthesis', opts: ['In this way, internal rivalry, ethnic divisions and Cold War competition together plunged Angola into civil war in 1975.', 'Therefore, the three movements went on to govern Angola together in complete harmony.', 'As a result, Angola avoided any kind of conflict after gaining its independence.', 'This shows that foreign powers had no interest at all in the future of Angola.'], c: 0, fb: 'A conclusion should draw the argument together. The first ties internal rivalry, ethnicity and the Cold War into the outbreak of war. The others contradict the evidence.'},
];

const MTA_ANSWERS = [
  {label: 'Answer A', text: 'There were several factors that led to the civil war in Angola in 1975. The three movements, the MPLA, FNLA and UNITA, all wanted to control the country. Source 2C says that they used armed struggle instead of talking to each other. Foreign countries also got involved and supported different sides in the war. This is why the movements ended up fighting each other in a civil war after independence.', expLv: 0, expM: '?-5', crit: [{q: 'Does it have a clear topic sentence addressing the question?', cor: 'partial', exp: 'It says there were \'several factors\' but does not name them clearly, so the topic is loosely framed.'}, {q: 'Does it use specific evidence from the sources?', cor: 'partial', exp: 'It refers to Source 2C but only generally, without developing the evidence about foreign appeals.'}, {q: 'Does it include own knowledge beyond the sources?', cor: 'no', exp: 'It stays inside the sources. There is no outside fact such as the Cold War proxy backing of the movements.'}, {q: 'Does it explain WHY (analysis), not just WHAT (description)?', cor: 'no', exp: 'It mostly describes that the movements fought rather than analysing the factors that caused it.'}, {q: 'Does it have a concluding sentence that synthesises?', cor: 'partial', exp: 'The last sentence restates that they fought but does not pull the factors together.'}, {q: 'Is it a coherent paragraph, not a list of disconnected sentences?', cor: 'yes', exp: 'The sentences follow on from one another and read as a connected paragraph.'}]},
  {label: 'Answer B', text: 'Several factors drew the MPLA, FNLA and UNITA into civil war in 1975. As Source 2C explains, the three movements never reconciled their differences and chose armed struggle over political bargaining, each appealing to foreign powers for support. Source 2D adds that the conflict became ethnicised, with each movement rooted in a different ethnic group. Beyond the sources, the Cold War turned Angola into a proxy battleground: the Soviet Union and Cuba backed the Marxist MPLA, while the United States and apartheid South Africa backed the FNLA and UNITA. Internal rivalry, ethnic division and superpower competition together plunged newly independent Angola into war.', expLv: 0, expM: '?-8', crit: [{q: 'Does it have a clear topic sentence addressing the question?', cor: 'yes', exp: 'The first sentence states directly that several factors drew the movements into war and previews them.'}, {q: 'Does it use specific evidence from the sources?', cor: 'yes', exp: 'It uses Source 2C (armed struggle, foreign appeals) and Source 2D (ethnicised conflict) with real detail.'}, {q: 'Does it include own knowledge beyond the sources?', cor: 'yes', exp: 'It adds the Cold War proxy backing of each movement, accurate facts from beyond the sources.'}, {q: 'Does it explain WHY (analysis), not just WHAT (description)?', cor: 'yes', exp: 'It explains how rivalry, ethnicity and superpower competition combined to cause the war.'}, {q: 'Does it have a concluding sentence that synthesises?', cor: 'yes', exp: 'The closing sentence ties the three factors together into the outbreak of war.'}, {q: 'Is it a coherent paragraph, not a list of disconnected sentences?', cor: 'yes', exp: 'It flows logically from claim to evidence to own knowledge to conclusion.'}]},
];
...
const KR_META = {interactiveId: 'history-p1-2023-nov-q2', paper: 'P1', section: 'A', questionNumber: 2, paperRef: 'DBE November 2023'};
