...
const SRC = {
  '1A': {
    ...
    html: `<div class="sp-body">Once a Second World War ally (friend) of the United States, the Soviet Union was quickly becoming a real threat to democracy around the world. The spread of communism was seen as the most dangerous threat to world stability and Truman was determined to take a hard line with the Soviets. American diplomat and historian George Kennan proposed the idea of containment; this concept would become the centrepiece of the Truman Doctrine. Containment was the concept of applying counterpressure to every political, military or economic advance wherever and whenever the Soviets tried to make them.<br><br>While not an entirely new idea, it was never seriously envisioned (intended) as a foreign policy until March of 1947 after a presidential address to Congress by Truman. Due to their own domestic hardships, England announced that they would be unable to continue to militarily and economically support the democratic and strategically located nations of Greece and Turkey. Truman decided it was time for the United States to step into the role of world leader, a role left vacant by the declining British Empire.<br><br>The Truman Doctrine was based on the principle of containing communism where it already existed and not allowing it to spread to neighbouring European nations like an unstoppable virus.</div>`,
    attr: 'From \'Truman Doctrine for APUSH\' by Dr J Roy, 22 February 2019'
  },
  '1B': {
    label: 'Source 1B',
    type: 'Speech Extract',
    html: `<div class="sp-body">In addition to funds, I ask Congress to authorise (approve) the detail of American civilian and military personnel to Greece and Turkey, at the request of those countries, to assist in the tasks of reconstruction, and for the purpose of supervising the use of such financial and material assistance as may be furnished. I recommend that authority also be provided for the instruction and training of selected Greek and Turkish personnel.<br><br>Finally, I ask that the Congress provide authority which will permit the speediest and most effective use, in terms of needed commodities, supplies and equipment, of such funds as may be authorised.<br><br>The seeds of totalitarian regimes are nurtured (supported) by misery and want. They spread and grow in the evil soil of poverty and strife (conflict). They reach their full growth when the hope of a people for a better life has died. We must keep that hope alive.<br><br>The free peoples of the world look to us for support in maintaining their freedoms. If we falter (fail) in our leadership, we may endanger the peace of the world &ndash; and we shall surely endanger the welfare of our own nation.</div>`,
    attr: 'From a speech by President Harry Truman to Congress, 12 March 1947 (in Proclaiming the Truman Doctrine by DM Bostdorff)'
  },
  '1C': {
    label: 'Source 1C',
    type: 'Political Cartoon',
    html: `<img class="sp-img" src="1C.png" alt="A cartoon. President Truman rides in a hot-air balloon labelled 'TRUMAN DOCTRINE', leaning out to scatter bags of US dollars over a map of Western Europe marked England, France, Belgium and Germany. Money covers the land and military tanks stand on it. In the top-left corner a dark cloud labelled 'VIRUS OF COMMUNISM', filled with cartoon germs, looms over the continent."><div class="sp-body" style="margin-top:12px;">Labels in the cartoon: 'Virus of Communism', 'Truman Doctrine', bags of US dollars ($), and military tanks.</div>`,
    attr: 'Cartoon by Mark Hill, US cartoonist (apprend.io APUSH resource)'
  },
  '1D': {
    label: 'Source 1D',
    type: 'Historical Article',
    html: `<div class="sp-body">During meetings in Szklarska Poreba, Poland, 22&ndash;27 September 1947, the Information Bureau of the Communist and Workers' Parties (Cominform) was established. It had nine founding parties from the USSR, Yugoslavia, Bulgaria, Romania, Hungary, Poland, Czechoslovakia, Italy and France.<br><br>The occasion of the meeting in September 1947 was a striking shift in the fortunes of communist parties in Western Europe. Until early 1947 Communists had access to power within coalition governments in France, Italy and Belgium. By the summer of 1947, however, the Truman Doctrine had been announced, and the powerful French, Italian and Belgian parties were removed from coalition governments.<br><br>The essence of the Cominform position was presented in several notices in the fall of 1947. The first was a communiqu&eacute; of 4 October 1947 which divided the world into two immutably (firm) hostile camps: the 'imperialist, anti-democratic camp' and the 'anti-imperialist, democratic camp'. The second took the form of an editorial in Pravda (10 October 1947), which confirmed the establishment of the Cominform and its role as an organisational bastion (defender) against an aggressively hostile, American-led, anti-socialist campaign.</div>`,
    attr: 'From \'The Stalinist Image of Canada: The Cominform and Soviet Press, 1947-1955\', Labour/Le Travailleur, 1988, by JL Black'
  },
  'compare': {
    label: 'Sources 1B + 1C',
    type: 'Comparison',
    html: `<div class="sp-body"><strong>Source 1B (Truman's speech)</strong><br><br>&hellip; I ask Congress to authorise the detail of American civilian and military personnel to Greece and Turkey &hellip; The free peoples of the world look to us for support in maintaining their freedoms. If we falter in our leadership, we may endanger the peace of the world &hellip;</div><div class="sp-body" style="margin-top:12px;"><strong>Source 1C (the cartoon)</strong></div><img class="sp-img" src="1C.png" alt="Truman in a 'Truman Doctrine' balloon scatters bags of US dollars over a map of Western Europe, with military tanks on the money-covered land and a 'Virus of Communism' cloud looming in the corner.">`,
    attr: 'Re-read both sources, then explain how they connect.'
  },
  'para': {
    label: 'Paragraph Task',
    type: 'Q1.6, 8 marks',
    html: `<div class="sp-body">Now build an eight-mark paragraph answering the guiding question: <em>How did the Truman Doctrine contribute to Cold War tensions between the USA and the USSR from 1947?</em><br><br>Work through it in four steps &ndash; a topic sentence, evidence from the sources, your own knowledge, and a synthesising conclusion. Choose the strongest option at each step.</div>`,
...
const QS = [
  {id: 'q1', src: '1A', num: '1.1.1', m: 2, t: 'Give TWO reasons in the source why Truman was determined to take a hard line with the Soviets. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['The spread of communism was seen as the most dangerous threat to world stability', 'The Soviet Union was becoming a real threat to democracy around the world', 'The Soviet Union had launched a direct military attack on the United States', 'Britain had asked the USA to declare open war on the Soviet Union', 'The United Nations had ordered the USA to invade Eastern Europe'], c: [0, 1], fb: 'The source says communism \'was seen as the most dangerous threat to world stability\' and the USSR \'was quickly becoming a real threat to democracy around the world\'. The other options are not in the source.'},
  {id: 'q2', src: '1A', num: '1.1.2', m: 2, t: 'Define the concept containment in your own words.', lv: 1, ll: 'Concept', opts: ['A policy of applying pressure to stop the spread of communism wherever the Soviets tried to advance.', 'A policy of removing communism by force from every country where it already existed.', 'An agreement to divide the world equally between the USA and the Soviet Union.', 'A plan to give economic aid to the Soviet Union to rebuild after the war.'], c: 0, fb: 'Containment meant applying \'counterpressure\' to block Soviet advances, stopping communism from spreading. The other options describe rollback, division, or aid to the USSR.'},
  {id: 'q3', src: '1A', num: '1.1.3', m: 4, t: 'Explain what is implied by the statement, \'Truman decided it was time for the United States to step into the role of world leader\', in the context of the Truman Doctrine.', lv: 2, ll: 'Interpretation', opts: ['It implies the USA took over from a declining Britain as the leading power defending democracy and resisting communism worldwide.', 'It implies the USA wanted to withdraw from world affairs and focus only on its own domestic problems.', 'It implies the USA planned to join the Soviet Union in jointly leading the communist world.', 'It implies Britain would remain the main world leader with only some US financial help.'], c: 0, fb: 'With Britain declining, the USA stepped up as the leading defender of democracy against communism. The other options suggest isolation, joining the USSR, or Britain staying in charge.'},
  {id: 'q4', src: '1A', num: '1.1.4', m: 2, t: 'Comment on why you think communism was regarded as a threatening \'unstoppable virus\' to neighbouring European nations.', lv: 2, ll: 'Interpretation', opts: ['Like a virus, communism was seen as spreading quickly from country to country and hard to stop once it took hold.', 'Communism was regarded as a virus because it made the people who believed in it physically ill.', 'Communism was called a virus because it only ever affected a few small, isolated nations.', 'Communism was seen as a virus that the USA itself wanted to spread across Europe.'], c: 0, fb: 'The \'virus\' image captures how communism was feared to spread rapidly between neighbouring countries. The other options take it literally or reverse who spread it.'},
  {id: 'q5', src: '1B', num: '1.2.1', m: 4, t: 'State FOUR requests in the source that Truman asked Congress to authorise in order to assist Greece and Turkey. Choose FOUR responses.', lv: 1, ll: 'Extraction', multi: true, mx: 4, opts: ['Send American civilian and military personnel to Greece and Turkey', 'Help with the tasks of reconstruction and supervise the use of assistance', 'Provide for the instruction and training of Greek and Turkish personnel', 'Allow the speediest and most effective use of the authorised funds', 'Send American soldiers to invade the Soviet Union directly', 'Give exactly the same aid to every country in Eastern Europe'], c: [0, 1, 2, 3], fb: 'Truman asked for personnel, help with reconstruction and supervision, training of Greek and Turkish personnel, and the speedy use of funds. The last two options are not in the source.'},
  {id: 'q6', src: '1B', num: '1.2.2', m: 2, t: 'Explain the concept totalitarian regimes in the context of the Truman Doctrine.', lv: 2, ll: 'Concept', opts: ['Governments, like communist ones, that totally control people\'s lives and allow no opposition.', 'Governments that are freely elected by the people in regular, fair multiparty votes.', 'Governments that give complete economic freedom to private business owners.', 'Governments that share power equally among many different political parties.'], c: 0, fb: 'Totalitarian regimes control every aspect of life and crush opposition, which is how the Doctrine viewed communism. The other options describe democracy or free-market systems.'},
  {id: 'q7', src: '1B', num: '1.2.3', m: 2, t: 'What do you think Truman meant by the statement, \'The seeds of totalitarian regimes are nurtured by misery and want\', regarding the spread of communism to Europe?', lv: 2, ll: 'Interpretation', opts: ['He meant that poverty and hardship push people towards communism, so aid was needed to remove that misery.', 'He meant that totalitarian regimes were the only real cure for poverty in post-war Europe.', 'He meant that communism could only ever grow in the wealthiest and most successful countries.', 'He meant that the USA should literally plant crops to feed the hungry people of Europe.'], c: 0, fb: 'Truman argued that poverty breeds communism, so removing hardship through aid would starve it of support. The other options misread the statement.'},
  {id: 'q8', src: '1B', num: '1.2.4', m: 2, t: 'Quote TWO reasons from the source why the United States of America could not falter (fail) in supporting the \'free peoples of the world\'. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['We may endanger the peace of the world', 'We shall surely endanger the welfare of our own nation', 'The Soviet Union had promised to attack the USA if it stopped its support', 'Congress had already spent all of its money on Greece and Turkey', 'The United Nations would expel the USA if it did not help'], c: [0, 1], fb: 'The source says that faltering means \'we may endanger the peace of the world\' and that \'we shall surely endanger the welfare of our own nation\'. The other options are not stated.'},
  {id: 'q9', src: '1C', num: '1.3.1', m: 4, t: 'Explain the messages that are conveyed in the cartoon regarding Cold War tensions between the USA and the Soviet Union from 1947.', lv: 2, ll: 'Interpretation', opts: ['It shows the USA pouring money and military support into Europe against the \'virus of communism\'.', 'It shows the USA and the Soviet Union working closely together to rebuild the whole of Europe.', 'It shows communism spreading successfully across Europe despite all American opposition.', 'It shows Europe rejecting the American money and choosing to become communist instead.'], c: 0, fb: 'The cartoon shows US dollars and tanks defending Europe against the \'virus of communism\', capturing the Truman Doctrine\'s aim. The other options reverse or misread it.'},
  {id: 'q10', src: '1C', num: '1.3.2', m: 4, t: 'Comment on the limitations of this source for a historian researching communism.', lv: 3, ll: 'Reliability', opts: ['As a cartoon it shows only the American view of communism as a threat, giving a one-sided, simplified picture rather than balanced fact.', 'It is limited because it was drawn hundreds of years before communism had come into existence.', 'It is limited because it gives detailed statistics on communist party membership across Europe.', 'It is limited because it fully and fairly presents the Soviet Union\'s own point of view.'], c: 0, fb: 'The cartoon is a one-sided American caricature of communism, not balanced evidence. The other options invent a wrong date, statistics, or false balance.'},
  {id: 'q11', src: 'compare', num: '1.4', m: 4, t: 'Study Sources 1B and 1C. Explain how the evidence in Source 1B supports the information in Source 1C regarding the assistance that the USA had given to Europe in order to contain the spread of communism.', lv: 3, ll: 'Comparison', opts: ['Both show US aid against communism: 1B has Truman funding Greece and Turkey, while 1C shows him showering Europe with dollars.', 'They contradict each other: 1B says the USA gave no aid while 1C shows it giving money to Europe.', 'Both show that the USA gave its financial and military support directly to the Soviet Union.', '1B supports 1C by proving that American aid completely failed to stop communism in Europe.'], c: 0, fb: 'Both show the USA funding Europe against communism, 1B in Truman\'s request and 1C in the dollar-scattering balloon. They agree; they do not contradict, aid the USSR, or show failure.'},
  {id: 'q12', src: '1D', num: '1.5.1', m: 2, t: 'Name any TWO countries in the source whose parties were members of Cominform in 1947. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['The USSR', 'Poland', 'The United States', 'Britain', 'Turkey'], c: [0, 1], fb: 'The source lists nine founding parties, including the USSR and Poland. The United States, Britain and Turkey were not Cominform members.'},
  {id: 'q13', src: '1D', num: '1.5.2', m: 2, t: 'Using the information in the source and your own knowledge, explain why, by the summer of 1947, the Truman Doctrine had become a threat to Cominform.', lv: 2, ll: 'Interpretation', opts: ['It committed American money and power to blocking communism, and communist parties were pushed out of Western coalition governments.', 'It offered the Soviet Union generous financial aid to help expand communism across Europe.', 'It promised to help communist parties win elections all across Western Europe.', 'It had no real effect at all on the spread or the strength of communism in Europe.'], c: 0, fb: 'The Doctrine backed anti-communist governments with US power, and communist parties lost their places in Western coalitions, threatening Cominform. The other options reverse this.'},
  {id: 'q14', src: '1D', num: '1.5.3(a)', m: 2, t: 'In the context of the Cold War, who, according to the Cominform, represented the \'imperialist, anti-democratic camp\'?', lv: 2, ll: 'Interpretation', opts: ['The United States and the American-led Western capitalist powers.', 'The Soviet Union and its communist allies in Eastern Europe.', 'The newly independent nations of Africa and Asia.', 'The defeated countries of Germany, Italy and Japan.'], c: 0, fb: 'The Cominform cast the USA and the Western capitalist powers as the \'imperialist, anti-democratic camp\'. The other options name the wrong group.'},
  {id: 'q15', src: '1D', num: '1.5.3(b)', m: 2, t: 'In the context of the Cold War, who, according to the Cominform, represented the \'anti-imperialist, democratic camp\'?', lv: 2, ll: 'Interpretation', opts: ['The Soviet Union and the communist bloc that it led.', 'The United States and its Western European allies.', 'The colonial empires of Britain and France.', 'The neutral, non-aligned states of the world.'], c: 0, fb: 'The Cominform cast itself and the Soviet-led bloc as the \'anti-imperialist, democratic camp\'. The other options name the wrong group.'},
  {id: 'q16', src: '1D', num: '1.5.4', m: 2, t: 'What, according to the source, did an editorial in the Pravda newspaper confirm regarding the Cominform? Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['The establishment of the Cominform', 'Its role as a defender against the American-led anti-socialist campaign', 'That the Cominform would soon be disbanded', 'That the USSR had decided to join the Truman Doctrine', 'That communism had already been defeated in Europe'], c: [0, 1], fb: 'The Pravda editorial \'confirmed the establishment of the Cominform and its role as an organisational bastion against an aggressively hostile, American-led, anti-socialist campaign\'. The others are not stated.'},
  {id: 'q17', src: 'para', num: '1.6a', m: 2, t: 'Choose the best topic sentence for a paragraph explaining how the Truman Doctrine contributed to Cold War tensions between the USA and the USSR from 1947.', lv: 3, ll: 'Synthesis', opts: ['The Truman Doctrine raised Cold War tensions from 1947 by committing the USA to contain communism.', 'The Truman Doctrine was a speech that President Truman gave to the US Congress in 1947.', 'Greece and Turkey are two countries that are located in the south-east of Europe.', 'There were many different opinions about communism during the whole twentieth century.'], c: 0, fb: 'A topic sentence must answer the question and set up an argument. Only the first states how the Doctrine raised tensions. The others are facts or vague background.'},
  {id: 'q18', src: 'para', num: '1.6b', m: 2, t: 'Which piece of source evidence best supports the topic sentence about the Truman Doctrine raising tensions?', lv: 3, ll: 'Synthesis', opts: ['Source 1B shows Truman asking Congress to fund Greece and Turkey to stop communism, directly challenging Soviet influence.', 'Source 1A mentions that the article about the Truman Doctrine was published in 2019.', 'Source 1D notes that the Cominform held only five conferences for the public record.', 'Source 1C was drawn by an American cartoonist named Mark Hill.'], c: 0, fb: 'Good evidence connects to the claim. Source 1B shows the USA directly funding anti-communist governments. The others are a publication date, an off-point fact, or an irrelevant detail.'},
  {id: 'q19', src: 'para', num: '1.6c', m: 2, t: 'Which piece of your own knowledge best strengthens the argument about the Truman Doctrine and Cold War tension?', lv: 3, ll: 'Synthesis', opts: ['The Soviet Union answered by forming Cominform in 1947 to bind communist parties together against the American-led West.', 'The Berlin Wall was built in 1961 to stop East Germans from fleeing to the West.', 'The United Nations was founded in 1945 to help maintain international peace.', 'Nelson Mandela was released from prison in South Africa in the year 1990.'], c: 0, fb: 'Own knowledge must fit 1947. The Soviet forming of Cominform was the direct counter to the Truman Doctrine. The others belong to different years or topics.'},
  {id: 'q20', src: 'para', num: '1.6d', m: 2, t: 'Choose the best concluding sentence that synthesises the paragraph\'s argument.', lv: 3, ll: 'Synthesis', opts: ['In this way, American aid and the Soviet counter-response hardened the divide between East and West from 1947.', 'Therefore, the USA and the Soviet Union stayed close and trusting allies well after 1947.', 'As a result, communism went on to spread freely across the whole of Western Europe.', 'This shows that the Truman Doctrine was really only about helping Greece and Turkey.'], c: 0, fb: 'A conclusion should draw the argument together. The first links US aid and the Soviet response to the deepening divide. The others contradict the evidence or shrink it.'},
];

const MTA_ANSWERS = [
  {label: 'Answer A', text: 'The Truman Doctrine caused Cold War tensions from 1947. Truman gave money to Greece and Turkey so that they would not become communist. Source 1B shows that Truman asked Congress for help. The USA wanted to stop communism from spreading further in Europe. This made the Soviet Union angry and so tension grew between the two countries after this happened.', expLv: 0, expM: '?-5', crit: [{q: 'Does it have a clear topic sentence addressing the question?', cor: 'partial', exp: 'It names the Doctrine and tension but does not clearly set out HOW it caused tension, so the topic is loosely framed.'}, {q: 'Does it use specific evidence from the sources?', cor: 'partial', exp: 'It refers to Source 1B but only generally, without the specific detail about funding and supporting Greece and Turkey.'}, {q: 'Does it include own knowledge beyond the sources?', cor: 'no', exp: 'It stays inside the sources. There is no outside fact such as the forming of Cominform in response.'}, {q: 'Does it explain WHY (analysis), not just WHAT (description)?', cor: 'no', exp: 'It mostly describes what the USA did and ends with \'tension grew\', without analysing why.'}, {q: 'Does it have a concluding sentence that synthesises?', cor: 'partial', exp: 'The last sentence restates that tension grew but does not pull the argument together.'}, {q: 'Is it a coherent paragraph, not a list of disconnected sentences?', cor: 'yes', exp: 'The sentences follow on from one another and read as a connected paragraph.'}]},
  {label: 'Answer B', text: 'The Truman Doctrine sharply raised Cold War tensions from 1947 by committing the United States to contain communism across the world. As Source 1B shows, Truman asked Congress to fund and support Greece and Turkey to keep them out of communist hands, framing it as defending the \'free peoples of the world\'. Source 1C pictures this as Truman showering Europe with dollars and military support against the \'virus of communism\'. Beyond the sources, the Soviet Union hit back by forming Cominform in September 1947 to unite communist parties against the American-led West. In this way, American intervention and the Soviet counter-response deepened the split between the two superpowers.', expLv: 0, expM: '?-8', crit: [{q: 'Does it have a clear topic sentence addressing the question?', cor: 'yes', exp: 'The first sentence states directly that the Doctrine raised tensions by committing the USA to contain communism.'}, {q: 'Does it use specific evidence from the sources?', cor: 'yes', exp: 'It uses Source 1B (funding Greece and Turkey) and Source 1C (the dollar-scattering cartoon) with real detail.'}, {q: 'Does it include own knowledge beyond the sources?', cor: 'yes', exp: 'It adds the forming of Cominform in September 1947, an accurate fact from beyond the sources.'}, {q: 'Does it explain WHY (analysis), not just WHAT (description)?', cor: 'yes', exp: 'It explains why US intervention and the Soviet counter-response deepened the divide, moving beyond description.'}, {q: 'Does it have a concluding sentence that synthesises?', cor: 'yes', exp: 'The closing sentence ties American aid and the Soviet response together into the widening East-West split.'}, {q: 'Is it a coherent paragraph, not a list of disconnected sentences?', cor: 'yes', exp: 'It flows logically from claim to evidence to own knowledge to conclusion.'}]},
];
...
const KR_META = {interactiveId: 'history-p1-2022-nov-q1', paper: 'P1', section: 'A', questionNumber: 1, paperRef: 'DBE November 2022'};
