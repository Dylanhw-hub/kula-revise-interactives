...
const QS = [
  ...
  {id: 'q8', src: '1B', num: '1.2.4', m: 2, t: 'Quote TWO reasons from the source why the United States of America could not falter (fail) in supporting the \'free peoples of the world\'. Choose TWO responses.', lv: 1, ll: 'Extraction', multi: true, mx: 2, opts: ['The free peoples of the world look to the USA for support in maintaining their freedoms', 'Faltering would endanger the peace of the world and the welfare of the nation', 'The Soviet Union had promised to attack the USA if it stopped its support', 'Congress had already spent all of its money on Greece and Turkey', 'The United Nations would expel the USA if it did not help'], c: [0, 1], fb: 'The source says \'the free peoples of the world look to us\' and that faltering \'may endanger the peace of the world ... and the welfare of our own nation\'. The other options are not stated.'},
